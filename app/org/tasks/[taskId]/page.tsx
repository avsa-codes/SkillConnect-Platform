        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground">{task.short_description}</p>
            </div>
          </div>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">
                      {task.duration_weeks ? `${task.duration_weeks} weeks` : "-"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{task.weekly_hours ?? "-"}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{task.start_date || "-"}</p>
                  </div>
                </div>
